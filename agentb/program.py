...
from .transposition.table import TranspositionTable
...
class Agent:
    ...
    def action(self, **referee: dict) -> RAction:
        ...
        _tr = referee.get("time_remaining")
        time_remaining = float(_tr) if _tr is not None else 60.0  # type: ignore[arg-type]
    ...
    def update(self, color: RPlayerColor, action: RAction, **referee: dict):
        ...
        print(self._trans_table._table.__len__())
